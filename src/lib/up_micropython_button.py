"""From https://github.com/dlech/micropython-ev3dev/blob/ev3dev-stetch/src/uev3dev/button.py"""
...
CENTER = const(28)
"""Center button key code (enter)"""

DOWN = const(108)
"""Down button key code"""
...
BACK = const(14)
"""Back button key code (backspace)"""
